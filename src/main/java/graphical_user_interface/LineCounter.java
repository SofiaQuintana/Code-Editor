 ...
 * @author zofia
 */
public class LineCounter extends JPanel implements CaretListener, DocumentListener, PropertyChangeListener {
    public final static float CENTER = 0.5f;
    public final static float RIGHT = 1.0f;
    private Color firstColor = new Color(255,255,255);
    private final static Border OUTER = new MatteBorder(0, 0, 0, 2,new Color(102, 102, 102));
    ...
    public LineCounter(JTextComponent component) {
        this(component, 3);
    }
    
    public LineCounter(JTextComponent component, int minimunDisplayDigits) {
        this.component = component;
        setFont(component.getFont());
        setBorderGap(5);
        setCurrentLineForeground(firstColor);
        setAlignment(RIGHT);
